...
The first part should give someone who has never played this position a thorough understanding of it.

![Half-guard position diagram](hf2.svg)

## Playing Half Guard

### Part 1 – Entering Half Guard as a Defensive Position
...
1. Understanding what half guard is
   ...
   3. Trade-offs
      ...
      3. Athleticism is less of a factor
2. Transitions
   1. Escape side control: cross-face + underhook → elbow escape → half guard
   2. Transition from mount: catch the leg → half guard
   3. Mount → elbow escape → half guard
3. Cross-face → elbow escape → half butterfly
4. Transitions
   1. Cross-face → bridge-roll reversal → top half
   2. Cross-face → bridge-roll reversal → elbow escape → half guard
...
6. When is the cross-face good or bad?
   ...
   2. Giving up the cross-face to get the underhook
   3. Giving up the underhook to get the overhook
   4. Cross-face and diagonal control (e.g., closed guard)
7. Transitions
   1. Hook sweep
   2. Shoulder-crunch variation
   3. Butterfly upgrade → butterfly sweep
8. Half-guard upgrades
   1. Butterfly hook
   2. High/low knee shield
   3. Lockdown
9. Half-guard downgrades
   1. Underhook + cross-face
   2. Knee pointing away
   3. Knee pointing toward the sky while being “flat”
10. Transitions
